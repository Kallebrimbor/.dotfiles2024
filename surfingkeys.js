...
api.addSearchAlias('t', 'TikTok', 'https://www.tiktok.com/search?q=', 's', null, null, null, {
    favicon_url: 'https://www.tiktok.com/favicon.ico'
});

api.addSearchAlias('m', 'Google Maps', 'https://www.google.com/maps/search/', 's', null, null, null, {
    favicon_url: 'https://www.google.com/maps/favicon.ico'
});

api.addSearchAlias('p', 'Prisjakt', 'https://www.prisjakt.no/search?search=', 's', null, null, null, {
    favicon_url: 'https://www.prisjakt.no/favicon.ico'
});
